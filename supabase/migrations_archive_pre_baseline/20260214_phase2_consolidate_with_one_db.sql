-- ============================================================================
-- Phase 2: Updated consolidate_rfid_events() with ONE DB Integration
-- ============================================================================
-- Updates the main consolidation function to:
-- 1. Use reader_id as LPI (TEXT) instead of UUID
-- 2. Lookup carrier/product/origin/destination from ONE DB
-- 3. Propagate all fields to processed_events
-- ============================================================================
