-- ============================================================================
-- Fix: Correct product_id lookup in consolidate_rfid_events()
-- ============================================================================
-- Problem: Function was looking up product by code = product_name
-- Solution: Look up product by name (LIKE match) since ONE_DB has full names
-- Also ensures postal_center_city_snapshot is always populated
-- ============================================================================
...
BEGIN
    ...
    LOOP
        ...
        WHERE r.reader_id = v_raw_event.reader_id  -- JOIN by LPI
        ...
        -- Get product_id - FIXED: Match by code only
        -- ONE_DB has product_name (e.g., "STANDARD")
        -- products table has code field that matches
        ...
        IF v_reader_info.reader_type = 'Entry' THEN
            ...
            LOOP
                ...
                -- Insert consolidated event with ALL fields
        ...
        ELSIF v_reader_info.reader_type = 'Mixed' THEN
            ...
            -- (This function needs to be updated similarly)
