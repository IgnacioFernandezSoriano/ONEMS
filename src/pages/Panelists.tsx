          ...
          <div className="bg-white rounded-lg shadow p-4 mb-6">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                {(filters.search || filters.city_id || filters.node_id || filters.status || filters.no_node) && (
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  ...
                  <div className="flex items-end pb-2">
                    <label className="flex items-center gap-2 cursor-pointer select-none">
                      <input
                        type="checkbox"
                        checked={filters.no_node}
                        onChange={(e) => setFilters({ ...filters, no_node: e.target.checked, node_id: '' })}
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-sm font-medium text-gray-700">No node assigned</span>
                      </div>
                    </label>
                  </div>
